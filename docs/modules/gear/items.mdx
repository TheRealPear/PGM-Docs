...
Item names can be found with the [Material Finder](/docs/reference/items/inventory#material-finder)
...
|---|---|---|---|
| `material` | <span className="badge badge--danger">Required</span>The item's material name. | [Material Name](/docs/reference/items/inventory#material-matchers) |
...
Custom banners can be given to the player using the banner element.

| Element | Description |
|---|---|
| `<banner> </banner>` | A banner design containing multiple cascading layers. |

| Sub-element | Description|
|---|---|
| `<layer/>` | Defines a specific pattern layer. |

##### Banner Attributes

| Attribute | Description | Value |
|---|---|---|
| `base-color` | Defines the base color of the banner. | [Dye Color Name](/docs/reference/misc/colors) |

##### Pattern Attributes

| Attribute | Description | Value |
|---|---|---|
| `pattern` | <span className="badge badge--danger">Required</span> The pattern type to apply. | [Pattern Type](/docs/reference/misc/banners) |
| `color` | <span className="badge badge--danger">Required</span> Color of the pattern. | [Dye Color Name](/docs/reference/misc/colors) |

```xml
<banner base-color="white">
    <layer pattern="straight cross" color="yellow" />
    <layer pattern="stripe top" color="yellow" />
    <layer pattern="stripe bottom" color="yellow" />
    <layer pattern="mojang" color="black" />
    <layer pattern="stripe middle" color="yellow" />
    <layer pattern="triangle top" color="yellow" />
</banner>
```
...
|---|---|---|
| `<material> </material` | An individual material to match.<br />*Does not accept a damage/data value.* | [Material Name](/docs/reference/items/inventory#material-matchers) |

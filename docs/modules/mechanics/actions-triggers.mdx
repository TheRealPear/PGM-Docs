...
| Attribute | Description | Value |
|---|---|---|
| `after` | The time, in seconds, to wait before triggering an action.<br />**Note:** The value must be between 0 and 60. | <span className="badge badge--primary">Number</span> |
...
| Attribute | Description | Value |
|---|---|---|
| `shop` | The individual shop to open. | [Shop ID](/docs/modules/gear/shops) |
...
| Attribute | Description | Value |
|---|---|---|
| `region` | The destination region to teleport the user to.<br />*This is available only for teleport action.* | [Region](/docs/modules/mechanics/regions) |
